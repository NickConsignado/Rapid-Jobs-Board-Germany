  ...
  return (
    <>
      ...
      <div className="col-lg-6">
        <p className="text-center fs-3 mt-5">Welcome to<b>"Rapid Jobs Board Germany"</b> - Your Gateway to a World of Opportunities!</p>
      ...
      <button className="btn btn-outline-danger  mt-3" type="submit"><Link to="/Jobs">View Careers</Link></button>
      </div>
    </div>
      <div className="col-lg-6">
      ...
      At <b>"Rapid Jobs Board Germany"</b>, we understand that every individual possesses unique skills, experiences, and aspirations. 
